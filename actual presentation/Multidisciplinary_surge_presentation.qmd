  ...
  var(--white)
          ...
          ">
            ...
            <div style="
              ...
              color:var(--muted);
            ">
              Physiological vitals are often
              <strong style="color:var(--red)">
                delayed indicators
              </strong>
              of biochemical disruption, creating dangerous delays in escalation decisions under ICU capacity constraints.
            </div>
      ...
      <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div class="card"
          ...
          <div style="color:var(--navy)">
            metabolomic datasets used for model development
          </div>
        ...
        <div class="card"
          ...
          <div style="color:var(--navy)">
            total patients across both clinical cohorts
          </div>
        ...
        <div class="card"
          ...
          <div style="color:var(--navy)">
            triage priority levels generated by the framework
          </div>
...
">
  ...
  <div class="card"
    ...
    <div style="
      ...
      color:var(--muted);
    ">
      Model 1 classifies patients as non-severe or severe using metabolomic biomarkers.
    </div>
  ...
  <div class="card"
    ...
    <div style="
      ...
      color:var(--muted);
    ">
      Model 2 flags patients at high risk of rapid deterioration using longitudinal trajectories.
    </div>
  ...
  <div class="card"
    ...
    <div style="
      ...
      color:var(--muted);
    ">
      Both outputs combine into a 2×2 framework generating P1–P4 triage recommendations.
    </div>
  ...
  <div class="card"
    ...
    <div style="
      ...
      color:var(--muted);
    ">
      Surge simulations evaluate ICU allocation strategies under constrained capacity.
    </div>
...
<div style="font-family:'EB Garamond',serif;font-size:40px;color:var(--navy);margin-bottom:10px;line-height:1.1">COVID Biomarker Dataset</div>
          <div style="display:flex;flex-wrap:wrap;gap:4px;margin-bottom:10px">
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px ;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Small sample · n=43</div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px ;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Class imbalance</div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px ;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Mexican cohort only</div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px ;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Delta &amp; Omicron specific</div>
          </div>
          ...
          <div style="padding:8px 10px;background:var(--off);border-radius:6px;font-size:12.5px;color:var(--muted);margin-bottom:8px">
...
<div style="font-family:'EB Garamond',serif;font-size:40px;color:var(--navy);margin-bottom:10px;line-height:1.1">COVID Longitudinal Dataset</div>
          <div style="display:flex;flex-wrap:wrap;gap:4px;margin-bottom:10px">
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Timepoint imbalance</div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Data leakage risk</div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">Independent obs. assumption</div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:10px;margin-bottom:10px;letter-spacing:.05em;text-transform:uppercase;padding:2px 7px;border-radius:20px;background:#fef2f2;border:1px solid #fecaca;color:var(--red)">No temporal modelling</div>
          </div>
          <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin-bottom:15px">
            <div style="background:var(--off);border-radius:6px;padding:10px;text-align:center">
...
<div class="pip2-num shared" style="width:28px;height:28px;font-size:11px;margin-right:8px;background:var(--dim);color:var(--white)">05</div>
        ...
        <!-- Bottom info cards -->
        <div class="card gl" style="padding:12px 16px;flex-shrink:0">
          <h3 style="color:var(--green);margin-bottom:5px;font-size:12px">What's included</h3>
        ...
        <div class="card" style="padding:12px 16px;flex-shrink:0;border-left:3px solid var(--blue);border-radius:0 7px 7px 0">
...
<div style="width:32px;height:32px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:15px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">1</div>
<div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
<div style="width:32px;height:32px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:15px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">2</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
<div style="width:32px;height:32px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:15px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">3</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
              ...
              <div style="flex:1;min-height:0;background:#fef2f2;border:1px solid #fecaca;border-radius:6px;padding:10px 14px;display:flex;align-items:center;justify-content:space-between">
                <span style="font-size:13px;color:var(--muted)"><strong style="color:var(--red)">−12</strong> metabolites dropped</span>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
<div style="width:32px;height:32px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:15px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">4</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
              ...
              <div style="display:flex;gap:6px;flex:1;min-height:0">
                <div style="flex:1;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  ...
                  <div style="font-family:'EB Garamond',serif;font-size:2rem;color:var(--green);line-height:1">+22</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:8px;color:var(--green);opacity:.8;margin-top:3px">symptoms · comorbidities</div>
                </div>
                <div style="flex:1;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-size:11px;color:var(--muted);margin-bottom:3px">M2.2 adds</div>
                  <div style="font-family:'EB Garamond',serif;font-size:2rem;color:var(--green);line-height:1">+7</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:8px;color:var(--green);opacity:.8;margin-top:3px">treatment · onset</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            ...
            <div style="width:32px;height:32px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:15px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">✓</div>
            </div>
            <div style="flex:1;display:flex;flex-direction:column;gap:6px">
              <div style="font-size:20;font-weight:600;color:var(--navy)">Final panels</div>
              <div style="display:flex;gap:6px;flex:1;min-height:0">
                <div style="flex:1;background:var(--blue-l);border:1px solid var(--blue-m);border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
...
<section class="slide" id="s6">
  ...
  <div class="body a2">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:50px;flex:1;min-height:0">

      <!-- ================= LEFT ================= -->
      <div style="display:flex;flex-direction:column;gap:50px;">

        <!-- CARD 1 -->
        <div style="background:#fff;border:1px solid var(--border);border-radius:18px;padding:30px;display:flex;flex-direction:column;gap:14px;box-shadow:0 12px 28px rgba(0,0,0,0.06)">

          <!-- HEADER STRIP -->
          <div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:8px;border-bottom:1px solid #e6f0ff">
            <div style="font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue);font-weight:800;margin-bottom:10px">
              Data limitation · Training set
            </div>
          </div>

          <!-- TITLE -->
          <div style="display:flex;align-items:center;gap:14px;margin-top:6px">
            <div style="width:15px;height:15px;border-radius:50%;background:var(--blue);box-shadow:0 0 0 7px rgba(59,130,246,0.15)"></div>

            <div style="font-size:26px;font-weight:900;color:var(--navy);margin-bottom:10px">
              Limited training data
            </div>

            <div style="margin-left:auto;font-size:12px;padding:6px 12px;border-radius:999px;background:rgba(59,130,246,0.12);color:var(--blue);font-weight:800">
              DATA LIMIT
            </div>
          </div>

          <!-- SIGNAL BAR -->
          <div style="height:7px;background:#eaf2ff;border-radius:999px;overflow:hidden;margin-left:30px">
            <div style="width:78%;height:100%;background:linear-gradient(90deg,var(--blue),var(--blue-m))"></div>
          </div>

          <!-- BODY -->
          <div style="font-size:17.5px;color:var(--muted);line-height:1.75;margin-left:30px">
            43 patients · strong class imbalance · increased false negative risk in small cohorts
          </div>

          <!-- RECOMMENDATION -->
          <div style="margin-left:30px;padding:16px 18px;background:linear-gradient(135deg,#f8fbff,#eef6ff);border-radius:14px;border-left:4px solid var(--blue)">
            <div style="font-size:12px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;color:var(--blue);margin-bottom:15px">
              Recommendation
            </div>
            <div style="font-size:18px;color:var(--navy);line-height:1.6;font-weight:500">
              Cross-institutional anonymised data sharing across hospital networks
            </div>
          </div>
        ...
        <div style="background:#fff;border:1px solid var(--border);border-radius:18px;padding:30px;display:flex;flex-direction:column;gap:14px;box-shadow:0 12px 28px rgba(0,0,0,0.06)">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:8px;border-bottom:1px solid #e6f0ff">
            <div style="font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue);font-weight:800;margin-bottom:10px">
              Model limitation · Interpretability
            </div>
          </div>

          <div style="display:flex;align-items:center;gap:14px;margin-top:6px">
            <div style="width:15px;height:15px;border-radius:50%;background:var(--blue-m);box-shadow:0 0 0 7px rgba(96,165,250,0.15)"></div>

            <div style="font-size:26px;font-weight:900;color:var(--navy);margin-bottom:10px">
              No model interpretability
            </div>

            <div style="margin-left:auto;font-size:12px;padding:6px 12px;border-radius:999px;background:rgba(96,165,250,0.12);color:var(--blue-m);font-weight:800">
              TRUST GAP
            </div>
          </div>

          <div style="height:7px;background:#eaf2ff;border-radius:999px;overflow:hidden;margin-left:30px">
            <div style="width:65%;height:100%;background:var(--blue-m)"></div>
          </div>

          <div style="font-size:17.5px;color:var(--muted);line-height:1.75;margin-left:30px">
            Black-box predictions reduce clinical trust — clinicians require explainable reasoning
          </div>
          ...
          <div style="margin-left:30px;padding:16px 18px;background:linear-gradient(135deg,#f8fbff,#eef6ff);border-radius:14px;border-left:4px solid var(--blue)">
            ...
            <div style="font-size:18px;color:var(--navy);line-height:1.6;font-weight:500">
              SHAP-based interpretability integrated into clinical dashboard
            </div>
          </div>
      ...
      <div style="display:flex;flex-direction:column;gap:50px;">
        ...
        <div style="background:#fff;border:1px solid var(--border);border-radius:18px;padding:30px;display:flex;flex-direction:column;gap:14px;box-shadow:0 12px 28px rgba(0,0,0,0.06)">
          ...
          <div style="height:7px;background:#eaf2ff;border-radius:999px;overflow:hidden;margin-left:30px">
            <div style="width:72%;height:100%;background:linear-gradient(90deg,var(--blue-m),var(--blue))"></div>
          </div>

          <div style="font-size:17.5px;color:var(--muted);line-height:1.75;margin-left:30px">
            Single cohort dataset · limited age and ethnic diversity · variant-specific training
          </div>
          ...
          <div style="margin-left:30px;padding:16px 18px;background:linear-gradient(135deg,#f8fbff,#eef6ff);border-radius:14px;border-left:4px solid var(--blue)">
            ...
            <div style="font-size:18px;color:var(--navy);line-height:1.6;font-weight:500">
              Multi-site validation + ethnicity-stratified model development
            </div>
          </div>
        ...
        <div style="background:#fff;border:1px solid var(--border);border-radius:18px;padding:30px;display:flex;flex-direction:column;gap:14px;box-shadow:0 12px 28px rgba(0,0,0,0.06)">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:8px;border-bottom:1px solid #e6f0ff">
            <div style="font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue);font-weight:800;margin-bottom:10px">
              Deployment limitation · Regulation
            </div>
          </div>

          <div style="display:flex;align-items:center;gap:14px;margin-top:6px">
            <div style="width:15px;height:15px;border-radius:50%;background:var(--navy);box-shadow:0 0 0 7px rgba(30,58,138,0.12)"></div>

            <div style="font-size:26px;font-weight:900;color:var(--navy);margin-bottom:10px">
              No regulatory approval
            </div>

            <div style="margin-left:auto;font-size:12px;padding:6px 12px;border-radius:999px;background:rgba(30,58,138,0.10);color:var(--navy);font-weight:800">
              BLOCKER
            </div>
          </div>

          <div style="height:7px;background:#eaf2ff;border-radius:999px;overflow:hidden;margin-left:30px">
            <div style="width:90%;height:100%;background:var(--navy)"></div>
          </div>

          <div style="font-size:17.5px;color:var(--muted);line-height:1.75;margin-left:30px">
            No consent framework · no clinical validation trial · not yet SaMD compliant
          </div>
          ...
          <div style="margin-left:30px;padding:16px 18px;background:linear-gradient(135deg,#f8fbff,#eef6ff);border-radius:14px;border-left:4px solid var(--blue)">
            ...
            <div style="font-size:18px;color:var(--navy);line-height:1.6;font-weight:500">
              Align with TGA SaMD regulatory approval pathway for clinical deployment
            </div>
          </div>
...
"
padding:18px 18px;border-radius:14px;text-decoration:none;color:white;
        background:linear-gradient(135deg,var(--navy),var(--blue));
      ...
      <div style="flex:1;min-height:0;overflow:hidden;
        ...
        <div style="display:flex;gap:6px;flex-shrink:0;">
          <button id="mvp-tab-sev" onclick="mvpTab('sev')"
            style="flex:1;padding:9px;font-size:20px;">
            Severity wins
          </button>
        ...
        <!-- SEVERITY -->
        <div id="mvp-sev" style="flex:1;display:flex;flex-direction:column;gap:12px;overflow:auto;">

          <div style="font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.4);">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:12px;">
            <thead>
              <tr style="border-bottom:1px solid rgba(255,255,255,.15)">
                <th style="text-align:left;padding:6px;color:rgba(255,255,255,.5);font-size:15px;">Field</th>
                <th style="text-align:right;padding:6px;color:rgba(255,255,255,.5);font-size:15px;">Value</th>
              </tr>
            </thead>
            <tbody>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px ">Priority 4</td><td style="text-align:right;color:var(--blue-m);font-size:20px">10</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px">Priority 3</td><td style="text-align:right;color:var(--blue-m);font-size:20px">20</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px">Priority 2</td><td style="text-align:right;color:var(--blue-m);font-size:20px">30</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px">Priority 1</td><td style="text-align:right;color:var(--blue-m);font-size:20px">40</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px">ICU beds</td><td style="text-align:right;color:var(--blue-m);font-size:20px">80</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px">Occupied</td><td style="text-align:right;color:var(--blue-m);font-size:20px">50</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px">Surge</td><td style="text-align:right;color:var(--blue-m);font-size:20px">Moderate</td></tr>
            </tbody>
          </table>

          <div style="font-size:20px;line-height:1.6;color:rgba(255,255,255,.75)">
            Severity Only: <strong>7.5</strong> deaths<br>
            Deterioration Only: <strong>8.0</strong> deaths<br>
            <span style="color:#86efac">Severity wins</span>
          </div>

        </div>

        <!-- DETERIORATION -->
        <div id="mvp-det" style="display:none;flex:1;flex-direction:column;gap:12px;overflow:auto;">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:12px;">
           <thead>
            ...
            <tbody>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">Priority 4</td><td style="text-align:right;color:#f9a8d4;font-size:20px ">10</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">Priority 3</td><td style="text-align:right;color:#f9a8d4;font-size:20px ">20</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">Priority 2</td><td style="text-align:right;color:#f9a8d4;font-size:20px ">30</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">Priority 1</td><td style="text-align:right;color:#f9a8d4 ;font-size:20px">40</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">ICU beds</td><td style="text-align:right;color:#f9a8d4 ;font-size:20px ">80</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">Occupied</td><td style="text-align:right;color:#f9a8d4;font-size:20px ">50</td></tr>
              <tr><td style="padding:6px;color:rgba(255,255,255,.75);font-size:20px;">Surge</td><td style="text-align:right;color:#f9a8d4;font-size:20px ">Crisis</td></tr>
            </tbody>
          </table>

          <div style="font-size:20px;line-height:1.6;color:rgba(255,255,255,.75)">
            Severity Only: <strong>27.9</strong> deaths<br>
            Deterioration Only: <strong>26.25</strong> deaths<br>
            <span style="color:#86efac">Deterioration wins</span>
          </div>
...
<div class="snav">
  ...
  <button class="sp" data-slides="8" onclick="go(8)"><span class="sn">09</span> Discussion</button>
  <button class="sp" data-slides="9" onclick="go(9)"><span class="sn">10</span> MVP</button>
  <div class="narr">
