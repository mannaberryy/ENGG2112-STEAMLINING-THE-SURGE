    ...
    <div style="display:flex;flex-direction:column;background:var(--white);border:1px solid var(--border);border-radius:10px;overflow:hidden;min-height:0;">
      ...
      <div style="display:flex;flex-direction:column;gap:0;flex:1;min-height:0;">
        ...
        <div style="padding:20px 24px;flex:1;display:flex;flex-direction:column;gap:12px;border-bottom:1px solid var(--border);">
          ...
          <div style="background:#e1f5ee;border:1px solid #1D9E75;border-radius:20px;padding:6px 14px;align-self:flex-start;display:flex;align-items:center;gap:8px;">
            <div style="width:6px;height:6px;border-radius:50%;background:#1D9E75;"></div>
            <span style="font-family:'JetBrains Mono',monospace;font-size:15px;color:#085041;">179 / 240 deteriorating cases detected</span>
          </div>
        </div>
        ...
        <div style="padding:20px 24px;flex:1;display:flex;flex-direction:column;gap:12px;">
          ...
          <div style="background:#fce8e8;border:1px solid #e24b4a;border-radius:20px;padding:6px 14px;align-self:flex-start;display:flex;align-items:center;gap:8px;">
            <div style="width:6px;height:6px;border-radius:50%;background:#e24b4a;"></div>
            <span style="font-family:'JetBrains Mono',monospace;font-size:15px;color:#791F1F;">61 false negatives remain</span>
          </div>
        </div>
...
<section class="slide" id="s6">
  ...
  <div class="body a2">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;flex:1;min-height:0;">
      ...
      <!-- CARD 1 -->
      <div style="display:flex;flex-direction:column;gap:0;background:var(--white);border:1px solid var(--border);border-radius:10px;overflow:hidden;">
        <div style="background:var(--navy);padding:18px 24px;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;">
          <div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue-m);margin-bottom:5px;">Data limitation · Training set</div>
            <div style="font-family:'EB Garamond',serif;font-size:40px;color:var(--white);line-height:1;">Limited training data</div>
          </div>
          <div style="font-family:'JetBrains Mono',monospace;font-size:10px;padding:5px 12px;border-radius:20px;background:rgba(147,197,253,.15);color:var(--blue-m);letter-spacing:.06em;">DATA LIMIT</div>
        </div>
        <div style="display:flex;flex-direction:column;gap:12px;padding:20px 24px;flex:1;">
          <div style="height:6px;background:var(--off);border-radius:999px;overflow:hidden;">
            <div style="width:78%;height:100%;background:linear-gradient(90deg,var(--blue),var(--blue-m));border-radius:999px;"></div>
          </div>
          <p style="font-size:20px;color:var(--muted);line-height:1.65;margin:0;margin-top:20px">43 patients · strong class imbalance · increased false negative risk in small cohorts</p>
          <div style="margin-top:auto;padding:14px 16px;background:var(--blue-l);border-left:3px solid var(--blue);border-radius:0 7px 7px 0;">
            <div style="font-family:'JetBrains Mono',monospace;font-size:20px;letter-spacing:.1em;text-transform:uppercase;color:var(--blue);margin-bottom:6px;">Recommendation</div>
            <div style="font-size:20px;color:var(--navy);line-height:1.55;font-weight:500;">Cross-institutional anonymised data sharing across hospital networks</div>
          </div>
        </div>
      </div>
      ...
      <div style="display:flex;flex-direction:column;gap:0;background:var(--white);border:1px solid var(--border);border-radius:10px;overflow:hidden;">
        <div style="background:var(--navy);padding:18px 24px;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;">
          <div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue-m);margin-bottom:5px;">Model limitation · Interpretability</div>
            <div style="font-family:'EB Garamond',serif;font-size:40px;color:var(--white);line-height:1;">No model interpretability</div>
          </div>
          <div style="font-family:'JetBrains Mono',monospace;font-size:10px;padding:5px 12px;border-radius:20px;background:rgba(147,197,253,.15);color:var(--blue-m);letter-spacing:.06em;">TRUST GAP</div>
        </div>
        <div style="display:flex;flex-direction:column;gap:12px;padding:20px 24px;flex:1;">
          <div style="height:6px;background:var(--off);border-radius:999px;overflow:hidden;">
            <div style="width:65%;height:100%;background:var(--blue-m);border-radius:999px;"></div>
          </div>
          <p style="font-size:20px;color:var(--muted);line-height:1.65;margin:0;margin-top:20px">Black-box predictions reduce clinical trust — clinicians require explainable reasoning</p>
          <div style="margin-top:auto;padding:14px 16px;background:var(--blue-l);border-left:3px solid var(--blue);border-radius:0 7px 7px 0;">
            <div style="font-family:'JetBrains Mono',monospace;font-size:20px;letter-spacing:.1em;text-transform:uppercase;color:var(--blue);margin-bottom:6px;">Recommendation</div>
            <div style="font-size:20px;color:var(--navy);line-height:1.55;font-weight:500;">SHAP-based interpretability integrated into clinical dashboard</div>
          </div>
        </div>
      </div>
      ...
      <div style="display:flex;flex-direction:column;gap:0;background:var(--white);border:1px solid var(--border);border-radius:10px;overflow:hidden;">
        <div style="background:var(--navy);padding:18px 24px;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;">
          <div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue-m);margin-bottom:5px;">Data limitation · Cohort bias</div>
            <div style="font-family:'EB Garamond',serif;font-size:40px;color:var(--white);line-height:1;">Demographic constraints</div>
          </div>
          <div style="font-family:'JetBrains Mono',monospace;font-size:10px;padding:5px 12px;border-radius:20px;background:rgba(147,197,253,.15);color:var(--blue-m);letter-spacing:.06em;">DATA BIAS</div>
        </div>
        <div style="display:flex;flex-direction:column;gap:12px;padding:20px 24px;flex:1;">
          <div style="height:6px;background:var(--off);border-radius:999px;overflow:hidden;">
            <div style="width:72%;height:100%;background:linear-gradient(90deg,var(--blue-m),var(--blue));border-radius:999px;"></div>
          </div>
          <p style="font-size:20px;color:var(--muted);line-height:1.65;margin:0;margin-top:20px">Single cohort dataset · limited age and ethnic diversity · variant-specific training</p>
          <div style="margin-top:auto;padding:14px 16px;background:var(--blue-l);border-left:3px solid var(--blue);border-radius:0 7px 7px 0;">
            <div style="font-family:'JetBrains Mono',monospace;font-size:20px;letter-spacing:.1em;text-transform:uppercase;color:var(--blue);margin-bottom:6px;">Recommendation</div>
            <div style="font-size:20px;color:var(--navy);line-height:1.55;font-weight:500;">Multi-site validation + ethnicity-stratified model development</div>
          </div>
        </div>
      </div>
      ...
      <div style="display:flex;flex-direction:column;gap:0;background:var(--white);border:1px solid var(--border);border-radius:10px;overflow:hidden;">
        <div style="background:var(--navy);padding:18px 24px;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;">
          <div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:var(--blue-m);margin-bottom:5px;">Deployment limitation · Regulation</div>
            <div style="font-family:'EB Garamond',serif;font-size:40px;color:var(--white);line-height:1;">No regulatory approval</div>
          </div>
          <div style="font-family:'JetBrains Mono',monospace;font-size:10px;padding:5px 12px;border-radius:20px;background:rgba(147,197,253,.15);color:var(--blue-m);letter-spacing:.06em;">BLOCKER</div>
        </div>
        <div style="display:flex;flex-direction:column;gap:12px;padding:20px 24px;flex:1;">
          <div style="height:6px;background:var(--off);border-radius:999px;overflow:hidden;">
            <div style="width:90%;height:100%;background:var(--navy);border-radius:999px;"></div>
          </div>
          <p style="font-size:20px;color:var(--muted);line-height:1.65;margin:0;margin-top:20px">No consent framework · no clinical validation trial · not yet SaMD compliant</p>
          <div style="margin-top:auto;padding:14px 16px;background:var(--blue-l);border-left:3px solid var(--blue);border-radius:0 7px 7px 0;">
            <div style="font-family:'JetBrains Mono',monospace;font-size:20px;letter-spacing:.1em;text-transform:uppercase;color:var(--blue);margin-bottom:6px;">Recommendation</div>
            <div style="font-size:20px;color:var(--navy);line-height:1.55;font-weight:500;">Align with TGA SaMD regulatory approval pathway for clinical deployment</div>
          </div>
        </div>
      </div>
