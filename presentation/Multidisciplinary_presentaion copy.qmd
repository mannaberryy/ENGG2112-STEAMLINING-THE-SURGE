...
<a 
  href="https://engg2112-steamlining-the-surge.onrender.com/"
  target="_blank"
  class="mvp-out"
  style="
    min-width:260px;
  ...
  onmouseenter="
    ...
    this.style.boxShadow='0 18px 42px rgba(0,0,0,.22)';
  "
  onmouseleave="
    this.style.transform='translateY(0)';
    this.style.boxShadow='0 12px 32px rgba(0,0,0,.16)';
  "
>
  ...
  <p style="
    ...
    margin:0;
  ">
    Interactive Flask dashboard with biomarker upload, deterioration prediction, and surge triage simulation.
  </p>
  ...
  <div style="
    ...
    margin-top:2px;
  ">
    engg2112-steamlining-the-surge.onrender.com
  </div>
