  ...
  <div class="body a2">
    <div class="row">
      ...
      <div class="col" style="display:flex;flex-direction:column;gap:10px">
        ...
        <div style="display:flex;gap:10px;flex:1;min-height:0">
          ...
          <div style="flex:1;display:flex;flex-direction:column;gap:0">
            ...
            <div class="pip2-node full-only" id="pn-f1" style="opacity:1;transform:none">
            ...
            <div class="pip2-node full-only" id="pn-f2" style="opacity:1;transform:none">
              <div class="pip2-num full">02</div>
              <div><div class="pip2-t">Any lab turnaround</div><div class="pip2-s">Full metabolomic profiling — specialist equipment</div></div>
            </div>
            <div class="pip2-arr">↓</div>
            <div class="pip2-node shared" id="pn-f3" style="opacity:1;transform:none">
            ...
            <div class="pip2-arr">↓</div>
            <div class="pip2-node shared" id="pn-f4" style="opacity:1;transform:none">
            ...
            <div class="pip2-arr">↓</div>
            <div class="pip2-node shared" id="pn-f5" style="opacity:1;transform:none">
          ...
          <div style="flex:1;display:flex;flex-direction:column;gap:0">
            ...
            <div class="pip2-node rapid-only" id="pn-r1" style="opacity:1;transform:none">
            ...
            <div class="pip2-node rapid-only" id="pn-r2" style="opacity:1;transform:none">
        ...
        <!-- Bottom info cards -->
        <div class="card gl" style="padding:10px 14px;flex-shrink:0">
          <h3 style="color:var(--green);margin-bottom:4px">What's included</h3>
          <p style="font-size:12px">Variables requiring <strong>no laboratory testing</strong>, obtainable directly from patient history and clinical assessment — plus metabolites common to both datasets with turnaround <strong>under 24 hours</strong>.</p>
        </div>

        <div class="card" style="padding:10px 14px;flex-shrink:0;border-left:3px solid var(--blue);border-radius:0 7px 7px 0">
          <h3 style="margin-bottom:4px">Same methodology, smaller input</h3>
          <p style="font-size:12px">Steps 03–05 (ExtraTrees → 5-fold CV → GridSearch) run identically. Only the feature pool entering step 03 differs.</p>
        </div>
      ...
      <div class="col-r" style="display:flex;flex-direction:column;gap:8px">
        ...
        <div style="font-family:'JetBrains Mono',monospace;font-size:8.5px;letter-spacing:.12em;text-transform:uppercase;color:var(--dim);flex-shrink:0">Rapid-test feature panel — how it was built</div>
        ...
        <div style="flex:1;min-height:0;background:var(--white);border:1px solid var(--border);border-radius:8px;padding:16px 18px;display:flex;flex-direction:column;justify-content:space-between;gap:0">
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
              <div style="width:20px;height:20px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:8px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">1</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
              <div style="font-size:11px;font-weight:600;color:var(--navy)">Two metabolomic datasets</div>
              <div style="display:flex;gap:6px;flex:1;min-height:0">
                <div style="flex:1;background:var(--blue-l);border:1px solid var(--blue-m);border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-family:'EB Garamond',serif;font-size:1.9rem;color:var(--blue);line-height:1">568</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:7.5px;color:var(--blue);margin-top:3px;opacity:.8">CBD features</div>
                </div>
                <div style="display:flex;align-items:center;color:var(--dim);font-size:16px;flex-shrink:0">∩</div>
                <div style="flex:1;background:#e0f2fe;border:1px solid #7dd3fc;border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-family:'EB Garamond',serif;font-size:1.9rem;color:#0ea5e9;line-height:1">593</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:7.5px;color:#0ea5e9;margin-top:3px;opacity:.8">CLD features</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
              <div style="width:20px;height:20px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:8px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">2</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
              <div style="font-size:11px;font-weight:600;color:var(--navy)">Take the intersection</div>
              <div style="flex:1;min-height:0;background:var(--off);border-radius:6px;padding:10px 14px;display:flex;align-items:center;justify-content:space-between">
                <span style="font-size:12px;color:var(--muted)">Metabolites in <strong style="color:var(--navy)">both</strong> datasets</span>
                <span style="font-family:'EB Garamond',serif;font-size:2rem;color:var(--navy)">47</span>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
              <div style="width:20px;height:20px;border-radius:50%;background:var(--red);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:8px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">3</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
              <div style="font-size:11px;font-weight:600;color:var(--navy)">Remove &gt;24h turnaround</div>
              <div style="flex:1;min-height:0;background:#fef2f2;border:1px solid #fecaca;border-radius:6px;padding:10px 14px;display:flex;align-items:center;justify-content:space-between">
                <span style="font-size:12px;color:var(--muted)"><strong style="color:var(--red)">−12</strong> metabolites dropped</span>
                <span style="font-family:'EB Garamond',serif;font-size:2rem;color:var(--navy)">35 <span style="font-size:1rem;color:var(--muted)">remain</span></span>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;padding-top:2px">
              <div style="width:20px;height:20px;border-radius:50%;background:var(--green);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:8px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">4</div>
              <div style="width:1px;flex:1;background:var(--border)"></div>
            </div>
            <div style="flex:1;padding-bottom:10px;display:flex;flex-direction:column;gap:6px">
              <div style="font-size:11px;font-weight:600;color:var(--navy)">Add no-lab clinical variables</div>
              <div style="display:flex;gap:6px;flex:1;min-height:0">
                <div style="flex:1;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-size:9.5px;color:var(--muted);margin-bottom:3px">M1.2 adds</div>
                  <div style="font-family:'EB Garamond',serif;font-size:1.7rem;color:var(--green);line-height:1">+22</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:7px;color:var(--green);opacity:.8;margin-top:3px">symptoms · comorbidities</div>
                </div>
                <div style="flex:1;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-size:9.5px;color:var(--muted);margin-bottom:3px">M2.2 adds</div>
                  <div style="font-family:'EB Garamond',serif;font-size:1.7rem;color:var(--green);line-height:1">+7</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:7px;color:var(--green);opacity:.8;margin-top:3px">treatment · onset</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style="display:flex;gap:8px;flex:1;min-height:0">
            <div style="display:flex;flex-direction:column;align-items:center;flex-shrink:0;padding-top:2px">
              <div style="width:20px;height:20px;border-radius:50%;background:var(--navy);color:var(--white);font-family:'JetBrains Mono',monospace;font-size:9px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0">✓</div>
            </div>
            <div style="flex:1;display:flex;flex-direction:column;gap:6px">
              <div style="font-size:11px;font-weight:600;color:var(--navy)">Final panels</div>
              <div style="display:flex;gap:6px;flex:1;min-height:0">
                <div style="flex:1;background:var(--blue-l);border:1px solid var(--blue-m);border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-family:'EB Garamond',serif;font-size:1.9rem;color:var(--blue);line-height:1">57</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:7.5px;color:var(--blue);opacity:.8;margin-top:3px">M1.2 features</div>
                </div>
                <div style="flex:1;background:#e0f2fe;border:1px solid #7dd3fc;border-radius:6px;padding:10px;text-align:center;display:flex;flex-direction:column;justify-content:center">
                  <div style="font-family:'EB Garamond',serif;font-size:1.9rem;color:#0ea5e9;line-height:1">42</div>
                  <div style="font-family:'JetBrains Mono',monospace;font-size:7.5px;color:#0ea5e9;opacity:.8;margin-top:3px">M2.2 features</div>
                </div>
              </div>
            </div>
          </div>
